...
export default function Cadastro() {
  ...
  function avancar() {
    ...
    if (!dados.senha) {
      novosErros.senha = "Digite uma senha";
      temErro = true;
    ...
    if (!confirmar) {
      novosErros.confirmar = "Confirme sua senha";
      temErro = true;
    } else if (dados.senha !== confirmar) {
      novosErros.confirmar = "As senhas não são iguais";
      temErro = true;
    }
